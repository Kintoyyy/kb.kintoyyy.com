...
Select your framework below for specific implementation instructions:
...
- The Analytics component should be placed at the root level of your application to ensure it tracks all page views.
- For production deployments, ensure Web Analytics is enabled in your Vercel project settings.
- Analytics data may take a few minutes to appear in the dashboard after deployment.
